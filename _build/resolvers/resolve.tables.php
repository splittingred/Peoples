...
if ($object->xpdo) {
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        case xPDOTransport::ACTION_INSTALL:
            $modx =& $object->xpdo;
            $modelPath = $modx->getOption('modxp.core_path',null,$modx->getOption('core_path').'components/modxp/').'model/';
            $modx->addPackage('modxp',$modelPath);

            $manager = $modx->getManager();

            $manager->createObjectContainer('MODxpItem');
